...
public class SpringGenerator {
    ...
    public void generateSpring(String proAddr,String appletName,Integer portNum) throws IOException, TemplateException {
        ...
        //Template test_template = cfg.getTemplate("test_template.ftl");
        ...
        //String test_outputPath = proAddr+"/src/test/java/com/"+appletName+"/mpinterface/MpInterfaceApplicationTest.java";
       ...
       // new File(test_outputPath).getParentFile().mkdirs();
       ...
       // Writer test_writer = new FileWriter(test_outputPath);
        // 填充模板并生成文件
        main_template.process(dataModel, main_writer);
       // test_template.process(dataModel, test_writer);
